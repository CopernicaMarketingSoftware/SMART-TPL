 ...
 */
%option extra-type="SmartTpl::Internal::v1::Tokenizer *"

/**
 *  Output to tokenizer.cpp please
 */
%option outfile="src/tokenizer_v1.cpp"
...
bool Tokenizer::process(TokenProcessor *parent, const char *buffer, size_t size)
{
    ...
    while ((id = yylex(_scanner)) != 0)
    {
        ...
        {
            // reset the token, it has been deleted by the parser 

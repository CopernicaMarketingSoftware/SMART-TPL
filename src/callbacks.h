...
void        smart_tpl_output_value          (void *userdata, const void *value);
...
private:
    ...
    /**
     *  Signature of the output value callback
     */
    static SignatureCallback _output_value;
...
public:
    ...
    /**
     *  Call the output value function
     *  @param  userdata        Pointer to user supplied data
     *  @param  value           Pointer to the value to output
     *  @see    smart_tpl_output_value
     */
    void output_value(const jit_value &userdata, const jit_value &value)
    {
        // construct the arguments
        jit_value_t args[] = {
            userdata.raw(),
        ...
        // create the instruction
        _function->insn_call_native("smart_tpl_output_value", (void *)smart_tpl_output_value, _output_value.signature(), args, sizeof(args)/sizeof(jit_value_t), 0);
    }
     ...
     */
    jit_value transfer_numeric(const jit_value &userdata, const jit_value &value)
    {
        // construct the arguments
        jit_value_t args[] = {
            userdata.raw(),

...
static struct smart_tpl_callbacks callbacks = {
    ...
    .output_value          = smart_tpl_output_value,
    .member                = smart_tpl_member,
    .member_at             = smart_tpl_member_at,
    .transfer_numeric      = smart_tpl_transfer_numeric,
    ...
    .equals                = smart_tpl_equals,
    .not_equals            = smart_tpl_not_equals,
    .greater               = smart_tpl_greater,
    .greater_equals        = smart_tpl_greater_equals,
    .lesser                = smart_tpl_lesser,
    .lesser_equals         = smart_tpl_lesser_equals,
    .binary_and            = smart_tpl_and,
    .binary_or             = smart_tpl_or,

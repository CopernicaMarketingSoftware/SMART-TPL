...
struct smart_tpl_callbacks {
    ...
    void        (*output_integer)       (void *userdata, SmartTpl::integer_t number);
    ...
    const void *(*transfer_integer)     (void *userdata, SmartTpl::integer_t data);
    ...
    SmartTpl::integer_t (*to_integer)   (void *userdata, const void *variable);
    ...
    void        (*assign_integer)       (void *userdata, const char *key, size_t keysize, SmartTpl::integer_t value);
    ...
    const void *(*params_append_integer)(void *userdata, const void *parameters, SmartTpl::integer_t value);

...
struct smart_tpl_callbacks {
    ...
    void        (*output_double)        (void *userdata, double number);
    void        (*output_value)         (void *userdata, const void *variable);
    ...
    const void *(*transfer_numeric)     (void *userdata, numeric_t data);
    ...
    const void *(*equals)               (void *userdata, const void *variable1, const void *variable2);
    const void *(*not_equals)           (void *userdata, const void *variable1, const void *variable2);
    const void *(*greater)              (void *userdata, const void *variable1, const void *variable2);
    const void *(*greater_equals)       (void *userdata, const void *variable1, const void *variable2);
    const void *(*lesser)               (void *userdata, const void *variable1, const void *variable2);
    const void *(*lesser_equals)        (void *userdata, const void *variable1, const void *variable2);
    const void *(*binary_and)           (void *userdata, const void *variable1, const void *variable2);
    const void *(*binary_or)            (void *userdata, const void *variable1, const void *variable2);

...
struct smart_tpl_callbacks {
    ...
    void        (*output_numeric)       (void *userdata, integer_t number);
    ...
    integer_t   (*to_numeric)           (void *userdata, const void *variable);
    ...
    void        (*assign_numeric)       (void *userdata, const char *key, size_t keysize, integer_t value);
    ...
    const void *(*params_append_numeric)(void *userdata, const void *parameters, integer_t value);
